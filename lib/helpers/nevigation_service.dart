...
final class NavigationService {
  ...
  static Future<dynamic> navigateToReplacementwithArg(String routeName, Map<String, dynamic>? map) =>
      navigatorKey.currentState!.pushReplacementNamed(routeName,  arguments: map);
